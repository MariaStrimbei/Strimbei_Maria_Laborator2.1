...
namespace Strimbei_Maria_Laborator2._1.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Strimbei_Maria_Laborator2_1Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Strimbei_Maria_Laborator2_1Context context, string[] selectedCategories, Book bookToUpdate)
        {
